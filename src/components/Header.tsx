...
const navigation = [
  ...
  { name: "Crying", href: "#", current: false },
  { name: "Graduating", href: "#", current: false },
  { name: "Sleeping", href: "#", current: false },
];
          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-14 items-center justify-between">
                      ...
                      <a
                        ...
                        className={classNames(
                          item.current
                            ...
                            : "no-underline text-purple-300 hover:bg-purple-700 hover:text-white",
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  type="button"
                  className="rounded-full bg-purple-800 p-1 text-purple-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                >
                  ...
                  <div>
                    <Menu.Button className="flex rounded-full bg-purple-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <img
                        ...
                        src="https://media.licdn.com/dms/image/D5603AQEjcre84lMKFQ/profile-displayphoto-shrink_400_400/0/1663706177584?e=1681344000&v=beta&t=KTGeTvtp47s9FSO_M7fiAsQB-s7vKaeiGM8Ufs9SIhw"
                        alt=""
                      />
                    </Menu.Button>
                  </div>
